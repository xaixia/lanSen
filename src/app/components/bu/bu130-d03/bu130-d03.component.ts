...
@Component({
  selector: 'app-bu130-d03',
  templateUrl: './bu130-d03.component.html',
  styleUrls: ['./bu130-d03.component.scss']
})
export class Bu130D03Component implements OnInit {
  ...
  showChangeComponentCode(event: any) {
      this.ComponentCode = event.target.value;
  }

  showChangeCasPartment(event: any) {
    this.CasPartment = event.target.value;
  }

  createGridData(): any[] {
    return [
      {ComponentCode: '10000', ComponentName: '大阪倉庫', CasPartment: '梅田事業所', Doctor: '対象', Address: 'XXXXXXXXXXXXXXXXXXXXXXXX'},
      {ComponentCode: '20000', ComponentName: '東京倉庫', CasPartment: '新宿事業所', Doctor: '対象外', Address: 'XXXXXXXX'},
      {ComponentCode: '30000', ComponentName: '広島倉庫', CasPartment: '広島南区事業所', Doctor: '対象', Address: 'XXXXXXXX'},
      {ComponentCode: '40000', ComponentName: '鹿児島倉庫', CasPartment: '指宿事業所', Doctor: '対象外', Address: 'XXXXXXXX'},
      {ComponentCode: '10000', ComponentName: '大阪倉庫', CasPartment: '梅田事業所', Doctor: '対象', Address: 'XXXXXXXXXXXXXXXXXXXXXXXX'},
      {ComponentCode: '20000', ComponentName: '東京倉庫', CasPartment: '新宿事業所', Doctor: '対象外', Address: 'XXXXXXXX'},
      {ComponentCode: '30000', ComponentName: '広島倉庫', CasPartment: '広島南区事業所', Doctor: '対象', Address: 'XXXXXXXX'},
      {ComponentCode: '40000', ComponentName: '鹿児島倉庫', CasPartment: '指宿事業所', Doctor: '対象外', Address: 'XXXXXXXX'},
